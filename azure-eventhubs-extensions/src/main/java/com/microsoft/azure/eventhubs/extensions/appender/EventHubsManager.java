...
public final class EventHubsManager extends AbstractManager
{
	...
	public void send(final byte[] msg) throws EventHubsException
	{
		if (msg != null)
		{
	...
	public void send(final Iterable<byte[]> messages) throws EventHubsException
	{
		if (messages != null)
		{
	...
	public void startup() throws EventHubsException, IOException
	{

...
public final class PartitionSender extends ClientEntity {
     ...
     */
    static CompletableFuture<PartitionSender> Create(MessagingFactory factory, String eventHubName, String partitionId) throws EventHubsException {
    ...
    private CompletableFuture<Void> createInternalSender() throws EventHubsException {

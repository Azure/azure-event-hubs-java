 ...
 */
public class EventHubsException extends Exception
{
	...
	EventHubsException(final boolean isTransient)
	{
		super();
		this.isTransient = isTransient;
	}

	public EventHubsException(final boolean isTransient, final String message)
	{
		super(message);
		this.isTransient = isTransient;
	}

	public EventHubsException(final boolean isTransient, final Throwable cause)
	{
		super(cause);
		this.isTransient = isTransient;
	}

	public EventHubsException(final boolean isTransient, final String message, final Throwable cause)
	{
		super(message, cause);
		this.isTransient = isTransient;
	}

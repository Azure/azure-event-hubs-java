...
public final class MessageReceiver extends ClientEntity implements IAmqpReceiver, IErrorContextProvider {
    ...
    private CompletableFuture<MessageReceiver> createLink() {
        ...
        try {
            ...
            this.linkOpen.getWork().completeExceptionally(new EventHubsException(false, "Failed to create Receiver, see cause for more details.", ioException));
        }
    ...
    public void setPrefetchCount(final int value) throws EventHubsException {
        ...
        try {
            ...
            throw new EventHubsException(false, "Setting prefetch count failed, see cause for more details", ioException);
        }
    }
    ...
    public void onError(final Exception exception) {
        ...
        if (this.getIsClosingOrClosed()) {
            ...
            final boolean isTransientException = exception == null ||
                    (exception instanceof EventHubsException && ((EventHubsException) exception).getIsTransient());
            ...
            final Exception completionException = exception == null
                    ? new EventHubsException(true, "Client encountered transient error for unknown reasons, please retry the operation.") : exception;
    ...
    protected CompletableFuture<Void> onClose() {
        if (!this.getIsClosed()) {
            try {
                ...
                this.linkClose.completeExceptionally(new EventHubsException(false, "Scheduling close failed with error. See cause for more details.", ioException));
            }
        }

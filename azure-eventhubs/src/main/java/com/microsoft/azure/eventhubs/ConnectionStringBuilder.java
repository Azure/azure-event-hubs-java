...
/**
 * {@link ConnectionStringBuilder} can be used to construct a connection string which can establish communication with EventHubs entities.
 * It can also be used to perform basic validation on an existing connection string.
 * <p> Sample Code:
 * <pre>{@code
 * 	ConnectionStringBuilder connectionStringBuilder = new ConnectionStringBuilder(
 *     "EventHubsNamespaceName",
 *     "EventHubsEntityName", // eventHubName
 ...
 * <li> EntityPath - the path to the entity (eventhub)
...
public class ConnectionStringBuilder {
     ...
     * Build a connection string consumable by {@link com.microsoft.azure.eventhubs.EventHubClient#createFromConnectionString(String)}
     *
     * @param endpointAddress     namespace level endpoint. This needs to be in the format of scheme://fullyQualifiedEventHubsNamespaceEndpointName
     * @param entityPath          Entity path. For eventHubs case specify - eventHub name.
     * @param sharedAccessKeyName Shared Access Key name
     * @param sharedAccessKey     Shared Access Key
     */
    ...
    /**
     * Get the endpoint which can be used to connect to the EventHubs Namespace
     *
     * @return Endpoint
     */
    ...
    /**
     * OperationTimeout is applied in erroneous situations to notify the caller about the relevant {@link EventHubsException}
     *
     ...
     * <p>RetryPolicy is not inter-operable with EventHubs clients in other platforms.
     *
    ...
    /**
     * Returns an inter-operable connection string that can be used to connect to EventHubs Namespace
     *
        ...
        while (keys.find()) {
            ...
            if (key.equalsIgnoreCase(EndpointConfigName)) {
                ...
                try {
                    ...
                    throw new IllegalConnectionStringFormatException(
                            String.format(Locale.US, "%s should be in format scheme://fullyQualifiedEventHubsNamespaceEndpointName", EndpointConfigName),
                            exception);
                }

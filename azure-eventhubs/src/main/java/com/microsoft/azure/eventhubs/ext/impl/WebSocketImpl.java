 ...
 */
package com.microsoft.azure.eventhubs.ext.impl;

import com.microsoft.azure.eventhubs.ext.WebSocket;
import com.microsoft.azure.eventhubs.ext.WebSocketHandler;
import com.microsoft.azure.eventhubs.ext.WebSocketHeader;
...
import static com.microsoft.azure.eventhubs.ext.WebSocketHandler.WebSocketMessageType.WEB_SOCKET_MESSAGE_TYPE_HEADER_CHUNK;
import static com.microsoft.azure.eventhubs.ext.WebSocketHandler.WebSocketMessageType.WEB_SOCKET_MESSAGE_TYPE_UNKNOWN;
...
{
    private int _maxFrameSize = (5 * 1024); // (4 * 1024) + (16 * WebSocketHeader.MED_HEADER_LENGTH_MASKED);

...
public class SessionHandler extends BaseHandler {
    protected static final Logger TRACE_LOGGER = Logger.getLogger(ClientConstants.EVENTHUBS_CLIENT_TRACE);
    ...
    private class SessionTimeoutHandler extends DispatchHandler {
        ...
        public void onEvent() {
            ...
            if (!sessionCreated && !sessionOpenErrorDispatched) {
                ...
                session.close();
                onRemoteSessionOpenError.accept(null, new EventHubsException(false, "session creation timedout."));
            }
        }
    }
}

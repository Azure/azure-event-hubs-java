    ...
    protected CompletableFuture<Void> onClose() {
        if (!this.getIsClosed()) {
            try {
                ...
                this.closeTask.completeExceptionally(new EventHubsException(false, "Failed to Close MessagingFactory, see cause for more details.", ioException));
            }
        }
    ...
    private class RunReactor implements Runnable {
        ...
        public void run() {
            ...
            try {
                ...
                EventHubsException sbException = new EventHubsException(
                        true,

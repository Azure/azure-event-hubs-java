...
import com.microsoft.azure.eventhubs.ext.Base64Util;
...
public class WebSocketUpgrade
{
    ...
    private String createWebSocketKey()
    {
        ...
        return Base64Util.encodeBase64StringLocal(key).trim();
    }
    ...
    public Boolean validateUpgradeReply(byte[] responseBytes)
    {
        ...
        while (scanner.hasNextLine())
        {
            ...
            if (line.toLowerCase().contains("sec-websocket-accept"))
            {
                ...
                String expectedKey = Base64Util.encodeBase64StringLocal(messageDigest.digest((this._webSocketKey + RFC_GUID).getBytes())).trim();

...
public final class EventProcessorHost {
    ...
    public EventProcessorHost(
        ...
        if (executorService != null) {
            ...
            this.executorService = Executors.newScheduledThreadPool(this.executorServicePoolSize, new NamedThreadFactory(hostName + "-ephint"));
        }
    ...
    public CompletableFuture<Void> unregisterEventProcessor() {
        ...
        if (!this.unregistered) {
	        ...
	        result = this.partitionManager.stopPartitions();

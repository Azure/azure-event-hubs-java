...
public final class EventProcessorHost
{
    ...
    private CheckpointAndLeaseManagerOptions checkpointAndLeaseManagerOptions = null;
            ...
            final ExecutorService executorService)
    {
        ...
        this.initializeLeaseManager = true;
        this.checkpointAndLeaseManagerOptions = new AzureStorageCheckpointAndLeaseManagerOptions();
    }
            ...
            ExecutorService executorService)
    {
    	...
    	if (this.checkpointAndLeaseManagerOptions == null)
    	{
    		...
    		this.checkpointAndLeaseManagerOptions = new CheckpointAndLeaseManagerOptions();
    	}
    ...
    public CheckpointAndLeaseManagerOptions getCheckpointAndLeaseManagerOptions() { return this.checkpointAndLeaseManagerOptions; }
    
    public void setCheckpointAndLeaseManagerOptions(CheckpointAndLeaseManagerOptions options) { this.checkpointAndLeaseManagerOptions = options; }
